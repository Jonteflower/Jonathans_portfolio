...
const tixyAppObject = {
    ...
    text: `The Tixy Flutter app was built with Flutter right after the release of Tixy’s web app. Like the React web app, it uses Google Cloud to power its infrastructure which made it a perfect complement to the web-based app. `,
